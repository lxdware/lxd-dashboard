            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="form" role="tabpanel" aria-labelledby="form-tab">
                ...
                <div class="modal-footer">
                  ...
                  <a class="btn btn-primary" href="#" onclick="createProfileUsingForm()" data-dismiss="modal">Submit</a>
                </div>
              </div>
              <div class="tab-pane fade" id="json" role="tabpanel" aria-labelledby="json-tab">
                ...
                <div class="modal-footer">
                  <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                  <a class="btn btn-primary" href="#" onclick="createProfileUsingJSON()" data-dismiss="modal">Submit</a>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="modal fade" id="editProfileModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              <label class="col-12 col-form-label" id="profileNameEditInput"></label>
              <div class="col-12">
                <div class="form-group text-right">
                  <pre>
...
<script>
  ...
  function loadRenameProfile(profileToRename){
    console.log("Loading rename modal for profile " + profileToRename)
    $("#renameProfileModalLabel").text("Rename profile: " + profileToRename);
    $("#profileToRename").val(profileToRename);
    $("#renameProfileModal").modal('show');
  }
