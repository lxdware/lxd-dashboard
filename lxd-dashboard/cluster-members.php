...
<body id="page-top">
  ...
  <!-- Delete Cluster Member Modal-->
  <div class="modal fade" id="deleteClusterMemberModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-2" id="deleteQuestionText">
            Are you sure you want to delete this cluster member?
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="force" id="forceDeleteCheck">
            <label class="form-check-label" for="forceDeleteCheck">
              Force Delete
            </label>
          </div>
          <input type="hidden" id="clusterMember" class="form-control" name="clusterMember">
        </div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          <a class="btn btn-primary" href="#" onclick="deleteClusterMember()" data-dismiss="modal">Yes</a>
        </div>
      </div>
    </div>
  </div>
...
<script>
  ...
  function loadDeleteClusterMemberModal(clusterMember){
    $("#deleteQuestionText").text("Are you sure you want to delete " + clusterMember + " from the cluster?");
    $("#clusterMember").val(clusterMember);
    $("#deleteClusterMemberModal").modal('show');
  }

  function deleteClusterMember(){
    var memberToDelete = $("#clusterMember").val();
    var forceDeleteCheck = "false";
