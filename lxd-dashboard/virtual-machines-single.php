                  ...
                  <div class="col-auto mt-4 ml-3">
                    <div class="page-header-subtitle">
                      <a href="#" id="remoteBreadCrumb"></a>
                       / 
                      <a href="#" id="instancesBreadCrumb"></a>
                    </div>
                          ...
                          <div class="col-xl-6 col-lg-12">
                            ...
                            <div class="row">
                              <div class="card col-6 border-0">
                                ...
                                <div class="card-body pt-1">
                                  <!-- CPU Progress Circle -->
                                  <div class="progress-circle mx-auto" id="cpuPercentageGauge" data-value='0.0'>
                              ...
                              <div class="card col-6 border-0">
                               ...
                               <div class="card-body pt-1">
                                 ...
                                 <div class="progress-circle mx-auto" id="memoryPercentageGauge" data-value='0.0'>
                                   <span class="progress-circle-left">
                                     <span class="progress-circle-bar border-primary"></span>
                                   </span>
                                   <span class="progress-circle-right">
                                ...
                                <div class="row">
                                  <div class="col-12">
                                    <table class="table table-sm">
                                      ...
                                      <tr><td class="pr-3 font-weight-bold">Memory Hugepages:</td> <td><span id="limitsMemoryHugepages"></span></td></tr>
                            ...
                            <div class="card col-12 border-0 mb-2">
                              ...
                              <div class="card-body pt-1">
                                <div class="row">
                                  <div class="col-12">
                                    <table class="table table-sm">
                                      <tr><td class="pr-3 font-weight-bold">Stateful:</td> <td><span id="migrationStateful"></span></td></tr>
                                    </table>
                                  </div>
                                </div>
                              </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <label class="col-3 col-form-label text-right">MDEV: <span class="text-danger">*</span></label>
              <div class="col-7">
                <div class="form-group">
                  <input type="text" id="gpuMdevInput" class="form-control" placeholder="" name="gpuMdevInput">
                </div>
              </div>
              <div class="col-1">
                <i class="far fa-sm fa-question-circle" title='Enter in the mdev profile to use. Default: (not set)'></i>
              </div>
            </div>
...
<script>
  ...
  function reloadPageContent(){
    ...
    switch(activeTab) {
      ...
      case "#nav-overview":
        $.get("./backend/lxd/virtual-machines-single.php?instance=" + encodeURI(instanceName) + "&remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&action=displayInstanceInfo", function (data) {
          ...
          if (data.status == "Running"){
            $.get("./backend/lxd/virtual-machines-single.php?instance=" + encodeURI(instanceName) + "&remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&action=retrieveGaugeStats", function (data) {
              data = JSON.parse(data);
        ...
        $.get("./backend/lxd/virtual-machines-single.php?instance=" + encodeURI(instanceName) + "&remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&action=displayInstanceStateInfo", function (data) {
          data = JSON.parse(data);
  ...
  function loadPageContent(){
    ...
    $.get("./backend/lxd/virtual-machines-single.php?instance=" + encodeURI(instanceName) + "&remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&action=displayInstanceInfo", function (data) {
      ...
      if (dataConfig.hasOwnProperty('limits.memory.hugepages')) { $("#limitsMemoryHugepages").text(dataConfig['limits.memory.hugepages']); }
      if (dataConfig.hasOwnProperty('limits.network.priority')) { $("#limitsNetworkPriority").text(dataConfig['limits.network.priority']); }
  
      if (dataConfig.hasOwnProperty('migration.stateful')) { $("#migrationStateful").text(dataConfig['migration.stateful']); }
      ...
      if (dataConfig.hasOwnProperty('security.secureboot')) { $("#securitySecureboot").text(dataConfig['security.secureboot']); }
  ...
  function stopInstanceForcefully(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&action=stopInstanceForcefully",  function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function restartInstance(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&action=restartInstance",  function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function freezeInstance(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&action=freezeInstance",  function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function snapshotInstance(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&name=" + encodeURI(snapshotName) + "&stateful=" + encodeURI(snapshotStateful) + "&action=snapshotInstance", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function renameInstance(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&name=" + encodeURI(newInstanceName) + "&action=renameInstance", function (data) {
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.status_code == 100 && operationData.metadata.status_code < 400){
        operationStatusCheck();
        redirectURL = "virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(newInstanceName);
  ...
  function copyInstance(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&name=" + encodeURI(copyName) + "&action=copyInstance", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function createInstanceFromSnapshot(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&snapshot=" + encodeURI(snapName) + "&name=" + encodeURI(copyName) + "&action=createInstanceFromSnapshot", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function publishImageFromSnapshot(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceSnapshotName) + "&description=" + encodeURI(description) + "&public=" + encodeURI(publicDownload) + "&os=" + encodeURI(os) + "&release=" + encodeURI(release) + "&action=publishInstanceSnapshot", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function migrateInstance(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&location=" + encodeURI(clusterInput) + "&action=migrateInstance", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function deleteInstance(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&action=deleteInstance", function (data) {
      ...
      if (operationData.status_code == 100 && operationData.metadata.status_code < 400){
        operationStatusCheck();
        redirectURL = "virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName)
        window.location.replace(redirectURL);
      }
  ...
  function attachInstanceProfile(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&name=" + encodeURI(profileName) + "&action=attachInstanceProfile", function (data) {
      //Sync operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function detachInstanceProfile(profileName){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&name=" + encodeURI(profileName) + "&action=detachInstanceProfile", function (data) {
      //Sync operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function restoreInstanceSnapshot(snapshotName){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&name=" + encodeURI(snapshotName) + "&action=restoreInstanceSnapshot", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function deleteInstanceSnapshot(snapshotName){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&name=" + encodeURI(snapshotName) + "&action=deleteInstanceSnapshot", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function publishInstance(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&description=" + encodeURI(description) + "&public=" + encodeURI(publicDownload) + "&os=" + encodeURI(os) + "&release=" + encodeURI(release) + "&action=publishInstance", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function loadInstanceLog(logPath){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&path=" + encodeURI(logPath) + "&action=loadInstanceLog", function (data) {
  ...
  function deleteInstanceLog(logPath){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&path=" + encodeURI(logPath) + "&action=deleteInstanceLog", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function deleteInstanceBackup(backupName){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&name=" + encodeURI(backupName) + "&action=deleteInstanceBackup", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function addInstanceDiskDevice(){
    ...
    $.get("./backend/lxd/virtual-machines-single.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + 
  ...
  function addInstanceGPUDevice(){
    ...
    "&mdev=" + encodeURI($("#gpuMdevInput").val()) + 
  ...
  function removeInstanceDevice(deviceName){
    ...
    $.get("./backend/lxd/virtual-machines-single.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&name=" + encodeURI(deviceName) + "&action=removeInstanceDevice", function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function editInstance(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&action=loadInstanceInformation", function (data) {
      //Sync operation type
      ...
      if (dataConfig.hasOwnProperty('boot.autostart')) { $("#instanceBootAutostartInput").val(dataConfig['boot.autostart']); }
      if (dataConfig.hasOwnProperty('boot.autostart.delay')) { $("#instanceBootAutostartDelayInput").val(dataConfig['boot.autostart.delay']); }
      if (dataConfig.hasOwnProperty('boot.autostart.priority')) { $("#instanceBootAutostartPriorityInput").val(dataConfig['boot.autostart.priority']); }
      if (dataConfig.hasOwnProperty('boot.host_shutdown_timeout')) { $("#instanceBootHostShutdownTimeoutInput").val(dataConfig['boot.host_shutdown_timeout']); }
      if (dataConfig.hasOwnProperty('boot.stop.priority')) { $("#instanceBootStopPriorityInput").val(dataConfig['boot.stop.priority']); }
      if (dataConfig.hasOwnProperty('cluster.evacuate')) { $("#instanceClusterEvacuateInput").val(dataConfig['cluster.evacuate']); }
      if (dataConfig.hasOwnProperty('limits.cpu')) { $("#instanceLimitsCpuInput").val(dataConfig['limits.cpu']); }
      if (dataConfig.hasOwnProperty('limits.disk.priority')) { $("#instanceLimitsDiskPriorityInput").val(dataConfig['limits.disk.priority']); }
      if (dataConfig.hasOwnProperty('limits.memory')) { $("#instanceLimitsMemoryInput").val(dataConfig['limits.memory']); }
      if (dataConfig.hasOwnProperty('limits.memory.hugepages')) { $("#instanceLimitsMemoryHugepagesInput").val(dataConfig['limits.memory.hugepages']); }
      if (dataConfig.hasOwnProperty('limits.network.priority')) { $("#instanceLimitsNetworkPriorityInput").val(dataConfig['limits.network.priority']); }
      ...
      if (dataConfig.hasOwnProperty('snapshots.schedule')) { $("#instanceSnapshotsScheduleInput").val(dataConfig['snapshots.schedule']); }
      if (dataConfig.hasOwnProperty('snapshots.schedule.stopped')) { $("#instanceSnapshotsScheduleStoppedInput").val(dataConfig['snapshots.schedule.stopped']); }
      if (dataConfig.hasOwnProperty('snapshots.pattern')) { $("#instanceSnapshotsPatternInput").val(dataConfig['snapshots.pattern']); }
      if (dataConfig.hasOwnProperty('snapshots.expiry')) { $("#instanceSnapshotsExpiryInput").val(dataConfig['snapshots.expiry']); }
  ...
  function updateInstanceForm(){
    ...
    $.get("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) +
    "&description=" + encodeURI($("#instanceDescriptionInput").val()) + 
    "&boot_autostart=" + encodeURI($("#instanceBootAutostartInput").val()) + 
    "&boot_autostart_delay=" + encodeURI($("#instanceBootAutostartDelayInput").val()) + 
    "&boot_autostart_priority=" + encodeURI($("#instanceBootAutostartPriorityInput").val()) + 
    "&boot_host_shutdown_timeout=" + encodeURI($("#instanceBootHostShutdownTimeoutInput").val()) + 
    "&boot_stop_priority=" + encodeURI($("#instanceBootStopPriorityInput").val()) + 
    "&cluster_evacuate=" + encodeURI($("#instanceClusterEvacuateInput").val()) + 
    "&limits_cpu=" + encodeURI($("#instanceLimitsCpuInput").val()) + 
    "&limits_disk_priority=" + encodeURI($("#instanceLimitsDiskPriorityInput").val()) + 
    "&limits_memory=" + encodeURI($("#instanceLimitsMemoryInput").val()) + 
    "&limits_memory_hugepages=" + encodeURI($("#instanceLimitsMemoryHugepagesInput").val()) + 
    "&limits_network_priority=" + encodeURI($("#instanceLimitsNetworkPriorityInput").val()) + 
    ...
    "&snapshots_schedule=" + encodeURI($("#instanceSnapshotsScheduleInput").val()) + 
    "&snapshots_schedule_stopped=" + encodeURI($("#instanceSnapshotsScheduleStoppedInput").val()) + 
    "&snapshots_pattern=" + encodeURI($("#instanceSnapshotsPatternInput").val()) + 
    "&snapshots_expiry=" + encodeURI($("#instanceSnapshotsExpiryInput").val()) + 
  ...
  function updateInstanceJson(){
    ...
    console.log("Info: updating instance " + instanceName);
    $.post("./backend/lxd/virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&action=updateInstanceInformation", {json: instanceUpdateJSON},  function (data) {
      //Async operation type
      var operationData = JSON.parse(data);
      console.log(operationData);
      if (operationData.error_code >= 400){
  ...
  function establishInstanceWebSocketConsoleConnection() {
    $.get("./backend/lxd/virtual-machines-single.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&action=retrieveHostAndPort", function (data) {
      var operationData = JSON.parse(data);
      console.log(operationData);
      ...
      .then(response => {
        ...
        $.get("./backend/lxd/virtual-machines-single.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&action=establishInstanceWebSocketConsoleConnection", function (data) {
          var operationData = JSON.parse(data);
  ...
  function establishInstanceWebSocketExecConnection() {
    $.get("./backend/lxd/virtual-machines-single.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&action=retrieveHostAndPort", function (data) {
      ...
      .then(response => {
        ...
        $.get("./backend/lxd/virtual-machines-single.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName) + "&instance=" + encodeURI(instanceName) + "&shell=" + encodeURI(execShellInput) + "&action=establishInstanceWebSocketExecConnection", function (data) {
          var operationData = JSON.parse(data);
          var operation = operationData.operation;
  ...
  $(document).ready(function(){
    ...
    $('#instancesBreadCrumb').text("Virtual Machines");
    $('#instancesBreadCrumb').attr("href", "virtual-machines.php?remote=" + encodeURI(remoteId) + "&project=" + encodeURI(projectName));
